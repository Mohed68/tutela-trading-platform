...
export default function SecureAdminControlPlane() {
  ...
  const stepUp = async () => {
    try {
      ...
      await refresh();
    } catch { setNotice("Step-up failed. Check the authenticator code and try again."); }
  };
