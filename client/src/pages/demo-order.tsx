...
export default function DemoOrderPage() {
  ...
  const contract=async()=>{setBusy(true);const value=await demoApi.createContract(order.orderId);navigate(demoRoutes.contract(value.contractId, order.scenarioId));};
