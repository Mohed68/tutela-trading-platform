...
export default function MetricsCards({ metrics, isLoading, onContinueVerification }: MetricsCardsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
      ...
      {onContinueVerification && (
        <KybStatusCard onContinueVerification={onContinueVerification} />
      )}
    </div>
  );
}
